...
export async function GET(req: NextRequest) {
  ...
  const [
    ...
    supabase.from('page_views').select('path').gte('created_at', since).eq('country', 'FR').neq('device', 'desktop'),
    supabase.from('page_views').select('country').gte('created_at', since).eq('country', 'FR').neq('device', 'desktop'),
    supabase.from('page_views').select('device').gte('created_at', since).eq('country', 'FR').neq('device', 'desktop'),
    supabase.from('page_views').select('utm_source, referrer').gte('created_at', since).eq('country', 'FR').neq('device', 'desktop'),
    supabase.from('page_views').select('created_at').gte('created_at', since).eq('country', 'FR').neq('device', 'desktop'),
